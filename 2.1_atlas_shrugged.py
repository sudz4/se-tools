...
#Sample input text
#### COPY/PASTE-> meet with bijah and hunter, discuss radius project methodology and first project. Had the meeting, went great, discussed coming to Charlotte next week. per Bijah's direction, I confirmed my availability and plan to be in charlotte next week. I logged in to the ServiceNow partner portal. starting to get squared away with my credentials with everything. planning to review platform implementation and other artifacts on the partner portal and now learning. reviewed design artifacts and started to organize collateral for first Radius project. met the new PM (Robin) on the call wit Hunter and Bijah. 
